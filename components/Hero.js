...
export default function Hero() {
    ...
    return(
        ...
        <div className="relative flex flex-col-reverse gap-5 xs:flex-col sm:flex-col-reverse xl:flex-row">
            ...
            <div className="text-white w-full xl:w-1/2 px-0 xl:px-10 flex flex-col justify-center content-center">
                <div className="flex flex-row mb-5">
                    <div className="py-1 px-5 bg-code text-black font-bold" data-aos="fade-down"> THE CODE </div>
                </div>
                <h1 className="text-white text-3xl xl:text-5xl" data-aos="fade-right"> 
            ...
            <div className="w-full xl:w-1/2 relative">
                <motion.img 
                    ...
                    src="./bank_book_white.png" className="z-20 -left-0 xl:-left-10 w-12/12 relative"
                />
                <motion.img 
                    ...
                    transition={{ease:[0.075, 0.82, 0.4, 1], duration:2, delay:.5}}
                    src="./bank_book_black.png" className="absolute top-0 w-10/12 scale-75 rotate-45 z-10 -right-0 xl:-right-24"
                    />
                <motion.img 
                    src="./code-phone-01.png" className="absolute top-28 xl:top-72 -right-16 xl:-right-52 z-10 w-7/12"
                    ...
                    />
                <motion.img 
                    src="./code-phone-02.png" className="absolute top-0 -left-10 xl:-left-20 z-10 w-6/12"
